            ...
            >
                <CardContent>
                    ...
                    <Container>
                        ...
                        <Container style={{ display: 'inline-flex', justifyContent: 'space-around', margin: 10 }}>
                            {colors.map((color) => (
                                <Skeleton key={color} animation={false} component="button" variant="circle" width={24} height={24} className={clsx(classes.circle, classes[color])} onClick={changePrimaryColor.bind(this, color)} />
                            ))}
                        </Container>
                    </Container>
                    <Container>
                        ...
                        <Container style={{ display: 'inline-flex', justifyContent: 'space-around', margin: 10 }}>
                            {colors.map((color) => (
                                <Skeleton key={color} animation={false} component="button" variant="circle" width={24} height={24} className={clsx(classes.circle, classes[color])} onClick={changeAccentColor.bind(this, color)} />
                            ))}
                        </Container>
                    </Container>
                </CardContent>
